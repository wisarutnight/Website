...
<title>แบบตอบรับการเข้าประชุมออนไลน์</title>
 ...
 <div class="container">
	<div class="row">
	<form class="form-horizontal" action="edit2.php" method="post">
	...
	<div class="form-group">
		...
		<div class="bg-primary">แก้ไขข้อมูลทั่วไป</div>
		<div class="col-sm-6">
		</div>
	</div>
	...
	<div class="col-sm-4">
		<input type="text" name="sername" class="form-control" value="<?php echo $sername?>">
	 </div>
	 </div>
	...
	<div class="form-group">
		<div class="col-sm-5"></div>
		<div class="bg-primary">แก้ไขข้อมูลเกี่ยวกับระบบ</div>
		<div class="col-sm-6">
		</div>
	</div>
