...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="menu4.php">ประวัติการประชุม</a></li>
...
<table class="table table-hover">
	<tr>
		<td>ประวัติการปชะชุม</td>
	</tr>
<?php 
	
$query = db()->query('SELECT no, userId, username, password, status, first, name, sername, position, tel,  telephone, statusnow, category, datein, dateout FROM users ORDER BY no DESC');
...
?>
<tr>
		<td>การประชุมครั้งที่ <?php echo $no;?></td>
		<td><a href="#?userId=<?php echo $userId;?>">ดูรายละเอียด</a></td>
</tr>
<?php
}
?>
